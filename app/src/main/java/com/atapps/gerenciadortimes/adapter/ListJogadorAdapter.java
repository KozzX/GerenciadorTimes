...
/**
 * Created by ANDRECANDIDO on 08/03/2016.
 */
public class ListJogadorAdapter extends BaseAdapter{

    private LayoutInflater inflater;
    private List<Jogador> jogadores;
    private DaoJogador db;

    public ListJogadorAdapter(Context context, List<Jogador> jogadores){
